...
mixin _$ProductFilterModel {
  ...
  String? get categeryId => throw _privateConstructorUsedError;
...
abstract class $ProductFilterModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {PaginationModel paginationModel, String? categeryId, String? sortBy});
    ...
    return _then(_value.copyWith(
      paginationModel: null == paginationModel
          ...
          : paginationModel // ignore: cast_nullable_to_non_nullable
              as PaginationModel,
      categeryId: freezed == categeryId
          ? _value.categeryId
          : categeryId // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$_ProductFilterModel implements _ProductFilterModel {
  _$_ProductFilterModel(
      {required this.paginationModel, this.categeryId, this.sortBy});
  ...
  @override
  String toString() {
    return 'ProductFilterModel(paginationModel: $paginationModel, categeryId: $categeryId, sortBy: $sortBy)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.categeryId, categeryId) ||
                other.categeryId == categeryId) &&
            (identical(other.sortBy, sortBy) || other.sortBy == sortBy));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, paginationModel, categeryId, sortBy);
